...
namespace IQToolsManagementConsole
{
    public partial class ucUserMangement : UserControl
    {
        ...
        private void LoadGroups()
        {
            ...
            /*dt = (DataTable)en.ReturnObject(clsGbl.cnnstr + ";Initial Catalog = " + clsGbl.iqtoolsDB, ClsUtility.theParams
                , "SELECT [GID],[GroupName] FROM aa_UserGroups", ClsUtility.ObjectEnum.DataTable, "mssql");
        ...
        private void LoadUsers()
        {
            ...
            dt = (DataTable)en.ReturnObject(clsGbl.cnnstr + ";Initial Catalog = " + clsGbl.iqtoolsDB, ClsUtility.theParams
                , "SELECT * FROM aa_users", ClsUtility.ObjectEnum.DataTable, "mssql");
        ...
        private void btnSaveUser_Click(object sender, EventArgs e)
        {
            if(txtUserName.Text != "" && txtEmail.Text != "")
            {
                if(passwordsMatch(txtPass1.Text, txtPass2.Text))
                {
                    ...
                    try
                    {
                        int i = (int)en.ReturnObject(clsGbl.cnnstr + ";Initial Catalog = " + clsGbl.iqtoolsDB
                            , ClsUtility.theParams, sqlString, ClsUtility.ObjectEnum.ExecuteNonQuery, "mssql");
        ...
        private void LoadUsersHistory()
        {
            ...
            string sql = "SELECT " +
	                     ...
	                     "   uh.LoginTime, " +
                         "   uh.LogOutTime " +
                         "FROM aa_UserHistory uh " +
                         "INNER JOIN aa_Users u " +
                         "ON uh.UID = u.UID"; 

            dt = (DataTable)en.ReturnObject(clsGbl.cnnstr + ";Initial Catalog = " + clsGbl.iqtoolsDB
                , ClsUtility.theParams, sql, ClsUtility.ObjectEnum.DataTable, "mssql");
            dgvUsers.DataSource = dt;
            dgvUsers.Refresh();
        }
    }
